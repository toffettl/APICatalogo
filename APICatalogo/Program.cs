...
builder.Services.AddCors(options =>
    ...
    policy =>
    {
        policy.WithOrigins("http://localhost:xxxx") //url que podera fazer requisições
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("SUPERADMIN", policy => policy.RequireRole("Admin").RequireClaim("id", "Toffetti"));
