...
namespace APICatalogo.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> RefreshToken(TokenModel tokenModel)
        {
            ...
            string? acceessToken = tokenModel.AcessToken
                                    ?? throw new ArgumentNullException(nameof(tokenModel));

            string? refreshToken = tokenModel.RefreshToken
                                    ?? throw new ArgumentException(nameof(tokenModel));

            var principal = _tokenService.GetPrincipalFromExpiredToken(acceessToken!, _configuration);
            ...
            {
                acceessToken = new JwtSecurityTokenHandler().WriteToken(newAccessToken),
